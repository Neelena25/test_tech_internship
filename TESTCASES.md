...
### GET-02 — Ввести строковое значение в поле SellerID

##### Шаги:

###### 1. Отправить GET baseUrl/api/1/sellarID/item с sellerID : "rr"
...
## 3. Получение cтатистики по объявлению (GET baseUrl/api/1/statistic/{id})

### GET-01 — Получение статистики существующего объявления

##### Шаги:

###### 1. Отправить GET baseUrl/api/1/statistic/{id} с id : 25c4a7ed-c175-4c04-96f1-372faf899f0d
...
### GET-02 — Получение статистики при некорректном вводе id

##### Шаги:

###### 1. Отправить GET baseUrl/api/1/statistic/{id} с id : 25c4a7ed-c175-4c04-96f1-372faf899f0d2dgwfvewefefw
...
## 4. Удалить объявление по идентификатору (DELETE baseUrl/api/2/item/{id})

### DEL-01 — Удаление существующего объявления

##### Шаги:

###### 1. Отправить DELETE baseUrl/api/2/item/{id} с id : c6815627-f498-4639-a77b-320f6cdb11d9

###### Ожидаемый результат:
- HTTP статус 200 (Request successful)
- В ответе:

### DEL-02 — Удаление объявления c некорректным форматом Id

##### Шаги:

###### 1. Отправить DELETE baseUrl/api/2/item/{id} с id : c6815627-f498-4639-a77b-320f6cdb11d9eews

###### Ожидаемый результат:
- HTTP статус 400 (Bad requesst)
- В ответе:
- {
    "result": {
...
### DEL-03 — Удаление несуществующего объявления

##### Шаги:

###### 1. Отправить DELETE baseUrl/api/2/item/{id} с id : c6815627-f498-4639-a77b-320f6cdb11d8
